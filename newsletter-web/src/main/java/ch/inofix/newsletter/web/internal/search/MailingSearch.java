...
public class MailingSearch extends SearchContainer<Mailing> {
	...
	// ch.inofix.newsletter.model.MailingImpl
	static {
	...
	public MailingSearch(PortletRequest portletRequest, String curParam, PortletURL iteratorURL) {

		super(portletRequest, new MailingDisplayTerms(portletRequest), new MailingSearchTerms(portletRequest), curParam,
				DEFAULT_DELTA, iteratorURL, headerNames, EMPTY_RESULTS_MESSAGE);

		MailingDisplayTerms displayTerms = (MailingDisplayTerms) getDisplayTerms();

		iteratorURL.setParameter(MailingDisplayTerms.CREATE_DATE, String.valueOf(displayTerms.getCreateDate()));
		iteratorURL.setParameter(MailingDisplayTerms.MODIFIED_DATE, String.valueOf(displayTerms.getModifiedDate()));
		iteratorURL.setParameter(MailingDisplayTerms.TITLE, String.valueOf(displayTerms.getTitle()));
		iteratorURL.setParameter(MailingDisplayTerms.USER_NAME, String.valueOf(displayTerms.getUserName()));
